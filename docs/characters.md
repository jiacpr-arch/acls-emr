...
> **สถานะรูป:** ตัวที่ 1-10 ครบทุก pose แล้ว — ตัวที่ 11-13 (ผู้ป่วยหญิง/ตั้งครรภ์/เด็ก)
> ยังไม่มีรูปจริง ใช้ SVG placeholder ไปก่อน generate ตาม prompt ด้านล่างได้เลย
...
### 11. `patient_female` — ผู้ป่วยหญิง (Patient)
- หญิงไทย วัย ~40-50 ปี ผมยาวประบ่าสีเข้ม หน้าตาอิดโรยเล็กน้อย
- **ชุดกาวน์ผู้ป่วยสีชมพูกะปิอ่อน** (#E4B0C6) สายรัดข้อมือโรงพยาบาล
- ใช้กับทุกเคสที่ผู้ป่วยเป็นหญิงและยังพูดได้ (รวมหญิงสูงอายุ — ตัวเดียวใช้กว้าง)
- **สถานะรูป:** ยังไม่มี — ใช้ SVG placeholder ไปก่อน
- บทพูดให้เฉพาะอาการ/ความรู้สึกของตัวเอง **ห้าม**พูดแทนทีมแพทย์

### 12. `patient_pregnant` — ผู้ป่วยตั้งครรภ์ (Patient)
- หญิงไทย วัย ~28-32 ปี **ครรภ์แก่เห็นท้องชัด** มือประคองท้อง
- **ชุดกาวน์ผู้ป่วยสีม่วงลาเวนเดอร์อ่อน** (#D4BCE4)
- ใช้เฉพาะเคสที่บทบอกชัดว่าท้องแก่/เห็นครรภ์ — ครรภ์อ่อนใช้ `patient_female` ปกติ
- **สถานะรูป:** ยังไม่มี — ใช้ SVG placeholder ไปก่อน

### 13. `patient_child` — ผู้ป่วยเด็ก (Patient)
- เด็กไทย วัย ~8-12 ปี (ประถม) ผมสั้นดำ หัวโตตาโตตามสัดส่วนเด็ก
- **เสื้อยืดสีเหลืองสด** (#F0C048) — เด็กทั่วไป ไม่ใช่ชุดผู้ป่วย
- ใช้กับเคสเด็กที่ยังพูดได้ (หอบหืด สำลัก ซักประวัติก่อนทรุด) —
  **ทารก/เด็กเล็กที่พูดไม่ได้** ไม่ต้องมี sprite ผู้ป่วย ให้ `family_witness` เล่าอาการแทน
- **สถานะรูป:** ยังไม่มี — ใช้ SVG placeholder ไปก่อน
