...
> **สถานะรูป:** ตัวที่ 1-8 ครบทุก pose แล้ว — เหลือ `patient_male` (ตัวที่ 9)
> ที่มีเฉพาะ `idle`/`talk` จึงยังติดธง `probeArt: true` ใน `src/game/characters.js`;
> เมื่อเติม `panic`/`stern`/`happy` ครบแล้ว **ลบ `probeArt` ออก**
...
### 10. `victim_uncle` — ลุงผู้ป่วย (Patient · Bystander)
- ชายไทย วัยกลางคน-สูงวัย ผมหงอก เสื้อเชิ้ตลายสก็อตแดง-กรมท่าธรรมดา (พลเรือน ไม่ใช่บุคลากรทางการแพทย์)
- **ชุดพลเรือน** (#8E4A45) — ใช้กับเคส BLS นอกโรงพยาบาลที่ผู้ป่วยยังพูดได้ก่อนทรุด
  (stroke ระยะแรก, เจ็บอก, น้ำตาลต่ำ, หมดสติกลางตลาดก่อนหมดสติ) เป็นตัว **generic**
  ใช้ซ้ำได้หลายเคสเหมือน `family_witness`
- บุคลิก: ผู้ป่วยทั่วไปที่ยังรู้สึกตัว พูดถึงอาการตัวเองตรงไปตรงมา
- **สถานะรูป:** ครบทั้ง 5 pose แล้ว
- บทพูดให้เฉพาะอาการ/ความรู้สึกของตัวเอง **ห้าม**พูดแทนทีมแพทย์หรือยืนยันหัตถการ
