...
2. ชื่อไฟล์ = `key` ที่ผูกไว้ในบทเคส (ดูตารางด้านล่างว่า key ไหนยังไม่มีไฟล์)
...
## Key ที่ผูกไว้ในบทแล้ว — ยังไม่มีไฟล์

| key | kind | ใช้ในเคส | รายละเอียด |
|---|---|---|---|
| `ecg_stemi` | xray | acsBasic (เจ็บหน้าอกสงสัย ACS) | 12-lead ECG แสดง ST elevation ที่ II, III, aVF |
