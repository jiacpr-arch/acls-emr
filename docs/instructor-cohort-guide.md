...
4. ระบบจะแสดง **รหัสคลาส 6 หลัก** — กด **"คัดลอก"** แล้วแจกให้นักเรียน
   (รหัสจะแสดงค้างอยู่บนหน้าอาจารย์พร้อมปุ่มคัดลอก กลับมาดู/แจกซ้ำได้ตลอด)

> ถ้ามีรหัสคลาสอยู่แล้ว (เช่น สร้างไว้จากเครื่องอื่น) กด **"มีรหัสคลาสอยู่แล้ว? เชื่อมต่อด้วยรหัส"** แทน
...
A: ได้ — ที่หน้าอาจารย์กด **"ใส่รหัสคลาสอื่น"** (หรือ **"สร้างคลาสใหม่"**)
หรือที่แถบสถานะคลาสในหน้า Pre-course กด **"เปลี่ยนคลาส"**
