...
// situation: 'cpr' | 'pulse_present' | 'post_rosc' — filters available devices
export default function OxygenDevice({ onClose, situation = 'pulse_present' }) {
  ...
  const allDevices = [
    { id: 'room_air', label: 'Room Air', icon: '🌬️', flowMin: 0, flowMax: 0, desc: 'No supplemental O₂', for: ['pulse_present', 'post_rosc'] },
    { id: 'nasal_cannula', label: 'Nasal Cannula', icon: '👃', flowMin: 1, flowMax: 6, desc: '1-6 L/min → FiO₂ 24-44%', defaultFlow: 3, for: ['pulse_present', 'post_rosc'] },
    { id: 'simple_mask', label: 'Simple Mask', icon: '😷', flowMin: 6, flowMax: 10, desc: '6-10 L/min → FiO₂ 40-60%', defaultFlow: 8, for: ['pulse_present', 'post_rosc'] },
    { id: 'nrb', label: 'Non-Rebreather (NRB)', icon: '🎭', flowMin: 10, flowMax: 15, desc: '10-15 L/min → FiO₂ 60-95%', defaultFlow: 15, for: ['pulse_present', 'post_rosc'] },
    { id: 'bvm', label: 'BVM (Bag-Valve-Mask)', icon: '🫁', flowMin: 10, flowMax: 15, desc: '10-15 L/min → FiO₂ ~100%', defaultFlow: 15, for: ['cpr', 'pulse_present', 'post_rosc'] },
    { id: 'ventilator', label: 'Mechanical Ventilator', icon: '🖥️', flowMin: 21, flowMax: 100, desc: 'FiO₂ 21-100%', defaultFlow: 100, isFiO2: true, for: ['post_rosc'] },
  ];
