...
const lessonDefs = [
  ...
  // ===================== บทที่ 2 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'ตำแหน่ง Pads มาตรฐาน',
        body: 'Anterior-lateral (นิยมที่สุด): แผ่นหนึ่งใต้ไหปลาร้าขวา แผ่นสองที่ชายโครงซ้ายแนวรักแร้กลาง (มักมีรูปวาดบนแผ่นกำกับตำแหน่งชัดเจน)\nตำแหน่งอื่นที่ใช้ได้เมื่อจำเป็น: anterior-posterior (หน้าอก-กลางหลัง) เช่นในเด็กเล็กหรือผู้ป่วยที่ anterior-lateral ทำไม่ได้' },
