...
const lessonDefs = [
  ...
  // ===================== บทที่ 2 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'การเปิดทางเดินหายใจ (Airway Opening)',
      ...
      { type: 'read', heading: 'เทคนิคการช่วยหายใจด้วย BVM',
      ...
      { type: 'read', heading: 'Pocket Mask และ Mouth-to-Mouth',
      ...
      { type: 'read', heading: 'สถานการณ์พิเศษในการช่วยหายใจ',
      ...
      { type: 'quiz', id: 'bls-2-q6',
        question: 'พบผู้ป่วยหมดสติจากอุบัติเหตุตกจากที่สูง สงสัยบาดเจ็บกระดูกสันหลังส่วนคอ ควรเปิดทางเดินหายใจด้วยวิธีใด?',
        choices: [
        ...
        correctId: 'b',
        explanation: 'สงสัย trauma/บาดเจ็บกระดูกสันหลังส่วนคอ ให้ใช้ jaw-thrust (ไม่เอียงศีรษะ) ก่อน ถ้าเปิดไม่ได้ผลจึงเปลี่ยนกลับมาใช้ head-tilt/chin-lift เพราะทางเดินหายใจโล่งสำคัญกว่าเสมอ' },
      { type: 'quiz', id: 'bls-2-q7',
        question: 'ขณะบีบ Ambu คนเดียวด้วยเทคนิค EC-clamp พบว่าลมรั่วจากขอบหน้ากาก หน้าอกไม่ยก ควรทำอย่างไร?',
        choices: [
        ...
        correctId: 'b',
        explanation: 'ถ้า mask seal ไม่สนิทและหน้าอกไม่ยก ให้เปลี่ยนเป็น 2-rescuer (double EC-clamp) ทันทีเพื่อให้ seal แน่นขึ้น ไม่ควรบีบแรง/เร็วขึ้นเพราะเสี่ยง gastric inflation' },
      { type: 'quiz', id: 'bls-2-q8',
        ...
        correctId: 'b',
        explanation: 'ผู้ป่วยมี stoma/tracheostomy ต้อง seal/ช่วยหายใจที่ตัว stoma หรือ tube โดยตรง ถ้าลมยังรั่วออกทางปาก/จมูกให้ปิดเสริมด้วย' },
      { type: 'quiz', id: 'bls-2-q9',
        question: 'ผู้ป่วยคลำชีพจรได้ปกติ แต่หายใจไม่พอ (respiratory arrest) ควรช่วยเหลืออย่างไร?',
        choices: [
          { id: 'a', text: 'กดหน้าอก 30:2 ตามปกติ' },
          { id: 'b', text: 'ช่วยหายใจอย่างเดียว 1 ครั้งทุก 6 วินาที ไม่กดหน้าอก และประเมินชีพจรซ้ำทุก ~2 นาที' },
          { id: 'c', text: 'ไม่ต้องทำอะไรจนกว่าจะหยุดหายใจสนิท' },
          { id: 'd', text: 'ช่วยหายใจ 1 ครั้งทุก 2 วินาที' },
        ],
        correctId: 'b',
        explanation: 'Respiratory arrest ที่ยังคลำชีพจรได้ ให้ช่วยหายใจอย่างเดียว ไม่กดหน้าอก อัตราผู้ใหญ่ 1 ครั้ง/6 วินาที (~10/min) และประเมินชีพจรซ้ำเป็นระยะ ถ้าคลำไม่ได้ให้เริ่ม CPR ทันที' },
    ],
  },
  ...
  // ===================== บทที่ 4 =====================
  {
    ...
    steps: [
      ...
      { type: 'quiz', id: 'bls-1r-q5',
        question: 'ผู้ช่วยเหลือพบผู้ป่วยไม่หายใจ ตรวจพบลักษณะ rigor mortis (กล้ามเนื้อแข็งเกร็งชัดเจน) ควรทำอย่างไร?',
        choices: [
        ...
        correctId: 'b',
        explanation: 'Rigor mortis เป็นสัญญาณ obvious/irreversible death — ผู้ช่วยเหลือรับรู้ได้และไม่ต้องเริ่ม CPR แต่ยังต้องแจ้งทีม/EMS ตามขั้นตอน' },
      { type: 'quiz', id: 'bls-1r-q6',
        ...
        correctId: 'a',
        explanation: 'TOR เป็นดุลยพินิจทางคลินิกของแพทย์เท่านั้น — BLS-HCP ทำ CPR ต่อเนื่องและรายงานทีม ไม่ใช่ผู้ตัดสินใจยุติการช่วยเหลือเอง' },
    ],
  },
  ...
  // ===================== บทที่ 5 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'สัญญาณบ่งชี้ ROSC — คนไข้กำลังรอด',
      ...
      { type: 'quiz', id: 'bls-4-q8',
        ...
        correctId: 'a',
        explanation: 'การขยับตัว ไอ สำลัก ลืมตา หรือตอบสนอง เป็นสัญญาณบ่งชี้ ROSC ที่ควรหยุดกดสั้น ๆ ตรวจชีพจร/การหายใจทันที ไม่ต้องรอครบรอบ 2 นาที' },
      { type: 'quiz', id: 'bls-4-q9',
        ...
        choices: [
          ...
          { id: 'b', text: 'Agonal gasping ไม่ใช่การหายใจที่มีประสิทธิภาพ อาจเกิดระหว่าง arrest ทำให้เข้าใจผิดว่าไม่ต้องกดหน้าอกต่อ' },
          { id: 'c', text: 'Agonal gasping พบเฉพาะหลัง ROSC เท่านั้น' },
          { id: 'd', text: 'ไม่มีความแตกต่างทางคลินิก' },
        ],
        correctId: 'b',
        explanation: 'Agonal gasping เป็นการหายใจที่ไม่มีประสิทธิภาพ อาจเกิดขึ้นระหว่างภาวะหัวใจหยุดเต้น หากเข้าใจผิดว่าเป็นการหายใจปกติอาจทำให้หยุด CPR ก่อนเวลาอันควร ต้องตรวจชีพจรยืนยันเสมอ' },
      ...
      { type: 'read', heading: 'อะไรกำหนดว่าคนไข้จะรอดชีวิต',
      ...
      { type: 'quiz', id: 'bls-4-q10',
        ...
        correctId: 'a',
        explanation: 'Chain of Survival ทุกห่วงมีผล แต่ปัจจัยหลักที่ทีม/ผู้ช่วยเหลือควบคุมได้คือ เริ่ม CPR และ defibrillation เร็ว บวกกับคุณภาพการกดหน้าอกที่ดี (CCF > 80%, interruption ≤ 10 วินาที)' },
    ],
  },
  ...
  // ===================== บทที่ 7 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'การเปิดทางเดินหายใจในทารก (Airway Opening)',
      ...
      { type: 'read', heading: 'เทคนิคการช่วยหายใจในทารก (Ventilation)',
      ...
      { type: 'read', heading: 'ทำไมทารก/เด็กเน้น "Phone Fast" ไม่ใช่ "Phone First"',
  ...
  // ===================== บทที่ 8 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'การดูแลหลังช่วยเหลือสำเร็จ (Post-relief Aftercare)',
