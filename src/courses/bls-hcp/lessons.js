  ...
  // ===================== บทที่ 1 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: 'Chain of Survival — IHCA (ใน รพ.)',
        body: '1) Early recognition + prevention (ใช้ MEWS / early warning score)\n2) Activate code blue / RRT พร้อมขอ defibrillator\n3) CPR คุณภาพสูง\n4) Defibrillation\n5) Post-cardiac arrest care\n6) Recovery' },
  ...
  // ===================== บทที่ 5 =====================
  {
    ...
    steps: [
      ...
      { type: 'quiz', id: 'bls-4-q4',
        ...
        correctId: 'b',
        explanation: 'AHA/ILCOR: limit interruption ทุกประเภท (สลับคน, AED วิเคราะห์, intubation, pulse check) ไม่เกิน 10 วินาที — เป้าฝึกของการสลับคนเองคือใน 5 วินาที แต่ formal limit ตามมาตรฐานคือ 10 วินาที' },
