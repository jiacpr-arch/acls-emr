// BLS-HCP Post-test Set B — 23 questions (BLS per ILCOR 2025 + TRC)
...
export const setB = {
  ...
  questions: [
    ...
    { id: 'bls-b-4', topic: 'high-quality-cpr',
      ...
      correctId: 'b', explanation: 'พื้นนุ่มลด effective depth → ใส่ backboard ใต้หลังผู้ป่วย; ไม่ควรย้ายลงพื้นเพราะเสียเวลา CPR และเสี่ยงบาดเจ็บเพิ่ม' },
    ...
    { id: 'bls-b-22', topic: 'choking',
      question: 'เด็กอายุ 3 ปี สำลัก ไอไม่ออก พูดไม่ได้ ทำอะไรตามแนวทาง ILCOR 2025?',
      choices: [
      ...
      correctId: 'b', explanation: 'ILCOR 2025: เด็ก ≥ 1 ปี severe obstruction ใช้ back blows สลับ abdominal thrusts (ครั้งละ 5 เหมือนผู้ใหญ่)' },
