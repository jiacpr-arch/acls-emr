  ...
  // ===================== บทที่ 6 =====================
  {
    ...
    steps: [
      ...
      { type: 'read', heading: '5 ลำดับสำคัญหลัง ROSC',
        body: '1) ดูแล Airway/Breathing ต่อ\n2) Oxygenation — SpO2 เป้า 90–98%; PaCO2 35–45 mmHg\n3) Hemodynamics — MAP ≥ 65 (hard target) → Norepinephrine first-line\n4) 12-lead ECG หา STEMI → PCI\n5) Temperature Control 32–37.5°C × ≥ 36 ชม. (แทน TTM เดิม)' },
      { type: 'quiz', id: 'pc6-q1', topic: 'postarrest', question: 'Target SpO2 หลัง ROSC ตามแนวทาง 2025 คือเท่าใด?',
        choices: [
          { id: 'a', text: '85–90%' },
          { id: 'b', text: '90–98%' },
          { id: 'c', text: '100%' },
        ...
        correctId: 'b',
        explanation: 'แนวทาง 2025: SpO2 90–98% (lower bound ลดจาก 94% เดิม) — หลีกเลี่ยงทั้ง hypoxia และ hyperoxia (free radical ทำลายสมอง)' },
      ...
      { type: 'read', heading: 'Temperature Control (เปลี่ยนจาก TTM)',
        body: 'แนวทาง 2025 เปลี่ยนชื่อ Targeted Temperature Management → Temperature Control:\n• เป้าหมาย 32–37.5°C ต่อเนื่อง ≥ 36 ชั่วโมง ในผู้ป่วยที่ไม่ทำตามคำสั่งหลัง ROSC\n• ครอบคลุมทั้ง hypothermic, normothermic และการป้องกันไข้\n• ใช้ cooling blanket / intravascular cooling\n• หลีกเลี่ยง prehospital cooling ด้วย cold IV fluid (เพิ่ม pulmonary edema และ re-arrest)' },
      { type: 'quiz', id: 'pc6-q4', topic: 'postarrest', question: 'Temperature Control ตามแนวทาง 2025 มีเป้าหมายอุณหภูมิและเวลาเท่าใด?',
        choices: [
          { id: 'a', text: '28–30 °C × 12 ชม.' },
          { id: 'b', text: '32–36 °C × 24 ชม. (เก่า)' },
          { id: 'c', text: '32–37.5 °C × ≥ 36 ชม.' },
          { id: 'd', text: '37–38 °C × 24 ชม.' },
        ],
        correctId: 'c',
        explanation: 'แนวทาง 2025: Temperature Control 32–37.5°C × ≥ 36 ชม. ในผู้ป่วยที่ไม่ทำตามคำสั่งหลัง ROSC — ครอบคลุมทั้ง hypothermic, normothermic และ fever prevention' },

      { type: 'read', heading: 'สิ่งที่ต้องหลีกเลี่ยง',
        body: 'หลัง ROSC อย่าทำสิ่งเหล่านี้:\n• Hyperventilation (PaCO2 < 35 → cerebral vasoconstriction); Hypoventilation (PaCO2 > 45)\n• Hyperoxia (SpO2 100% ต่อเนื่อง → free radical injury); Hypoxia (SpO2 < 90%)\n• Hyperthermia (> 37.5 °C); ไม่ทำ Temperature Control ในผู้ที่ไม่ทำตามคำสั่ง\n• Hypoglycemia (glucose < 70) และ Hyperglycemia (glucose > 180)\n• Prehospital cooling ด้วย cold IV fluid (เพิ่ม pulmonary edema, re-arrest)' },
      { type: 'quiz', id: 'pc6-q5', topic: 'postarrest', question: 'ข้อใดควรหลีกเลี่ยงในการดูแลหลัง ROSC?',
        choices: [
          { id: 'a', text: 'SpO2 90–98%' },
          { id: 'b', text: 'MAP ≥ 65' },
