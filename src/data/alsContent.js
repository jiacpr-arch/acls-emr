// Schema ของแต่ละ section (field ทั้งหมด optional ยกเว้นต้องมี body หรือ qa อย่างน้อย 1 อย่าง):
//   heading?: string                   หัวข้อย่อย
//   body?:    string                   เนื้อหาแบบข้อความปกติ (ของเดิม)
//   images?:  Array<Image>             รูปประกอบของ section (แสดงต่อจาก body)
//   qa?:      Array<QAItem>            รายการคำถาม-คำตอบ (Q&A)
//
// Image = { src: string, alt?: string, caption?: string }
//   - src ใส่ path แบบ absolute เช่น "/images/als/vf-rhythm.png"
//   - วางไฟล์รูปจริงไว้ที่ public/images/als/
//
// QAItem = { q: string, a: string, images?: Array<Image> }
//   - q  = คำถาม (plain text)
//   - a  = คำตอบในรูปแบบ Markdown (รองรับ heading ##/###, list, **bold**, ตาราง, blockquote ⚠️)
//   - images = รูปประกอบของ Q&A นี้ (แสดงระหว่างคำถามกับคำตอบ)
//   - สามารถใส่รูป inline ในคำตอบได้ด้วย: ![alt](/images/als/x.png)
export const alsChapters = [
  ...
  {
    id: 'ch9', title: 'บทที่ 9: การช่วยชีวิตเมื่ออาหารติดคอ (Choking)',
    icon: '🫁',
    sections: [
      {
        qa: [
