...
const sections = [
  {
    ...
    bullets: [
      ...
      'ไอไม่ออก / พูดไม่ได้ → ตบหลัง (Back Blows) 5 ครั้ง ระหว่างสะบัก',
      'ยังไม่หลุด → กระทุ้งท้อง (Abdominal Thrusts) 5 ครั้ง: ยืนด้านหลัง กำมือใต้สะดือ กระตุกเข้าและขึ้น',
      'สลับ Back Blows 5 ครั้ง / Abdominal Thrusts 5 ครั้ง จนวัตถุหลุด หรือผู้ป่วยหมดสติ',
