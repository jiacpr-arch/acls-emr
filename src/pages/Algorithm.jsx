    ...
    sections: [
      {
        ...
        items: [
          'SpO₂ 90-98% — avoid hypoxia AND hyperoxia',
          'PaCO₂ 35-45 mmHg — avoid hypo-/hypercarbia',
          'MAP ≥ 65 mmHg (hard target) — Norepinephrine first-line',
          '12-Lead ECG — STEMI? → Cath lab (PCI)',
        ],
        color: 'success',
      },
      {
        title: 'Temperature Control (was TTM)',
        items: [
          'Temperature Control 32–37.5°C × ≥ 36 hours',
          'Covers hypothermic, normothermic, and fever prevention',
          'Avoid prehospital cooling with cold IV fluids',
      ...
      },
      {
        ...
        items: [
          ...
          'Glucose 70–180 mg/dL (normoglycemia; avoid hypoglycemia)',
          'Seizure precaution & EEG monitoring',
          'CT head if no clear cardiac cause',
          'Neuroprognostication ≥ 72 hrs after return to normothermia + off sedation',
        ],
        color: 'warning',
      },
    ],
