...
const translations = {
  ...
  'games': { en: 'Games', th: 'เกมส์' },
  'games_subtitle': { en: 'Learn ACLS the fun way — play, practice, compete', th: 'เรียน ACLS แบบสนุก — เล่นเกม ฝึกซ้อม แข่งอันดับ' },
  'leaderboard': { en: 'Leaderboard', th: 'อันดับคะแนน' },
  'leaderboard_desc': { en: 'Code Blue Sim rankings', th: 'อันดับคะแนน Code Blue Sim' },
  ...
  'scenarios_desc': { en: 'Step 2 · Real Recording UI — pick Practice (hints) or Exam mode', th: 'ขั้น 2 · โจทย์บนหน้า Recording จริง — เลือกโหมดฝึก (มีคำใบ้) หรือโหมดสอบ' },
  ...
  'recorder_game_desc': { en: 'Step 1 · Mini game on mock buttons — rules shown before every round', th: 'ขั้น 1 · มินิเกมปุ่มจำลอง — มีสอนกติกาก่อนเริ่มทุกด่าน' },
  ...
  'learn_not_started': { en: 'Not started', th: 'รอเรียน' },
