...
**Circuit breaker:** ถ้าผลวิเคราะห์บอกว่าควร pause/ลดงบพร้อมกันเกิน 3 ตัวในรอบเดียว
อย่าเสนอ pause ทั้งหมดทันที — ให้บอกผู้ใช้ก่อนว่าจำนวนที่เข้าเกณฑ์สูงผิดปกติ (มีโอกาสเป็นบั๊ก
tracking/PostHog มากกว่า ads แย่จริงพร้อมกันหลายตัว) แล้วให้ผู้ใช้ตัดสินใจว่าจะตรวจเพิ่มก่อนหรือ
จะ pause จริง และไม่ว่าจำนวนจะเท่าไร ห้าม batch-confirm หลาย action ในคำถามเดียว — ถามยืนยัน
ทีละตัวเสมอ
